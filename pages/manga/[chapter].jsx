...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
        ...
        "@graph": [
            {
                ...
                "image": {
                    "@id": `${DOMAIN}/images/operation-true-love/chapter-${chapterNumber}/1.webp`,
                },
                "thumbnailUrl": `${DOMAIN}/images/operation-true-love/chapter-${chapterNumber}/1.webp`,
            ...
            },
            {
                ...
                "inLanguage": "en-US",
                "@id": `${DOMAIN}/${URL}/#primaryimage`,
                "url": `${DOMAIN}/images/operation-true-love/chapter-${chapterNumber}/1.webp`,
                "contentUrl": `${DOMAIN}/images/operation-true-love/chapter-${chapterNumber}/1.webp`,
            },
            {
                "@type": "BreadcrumbList",
                "@id": `${DOMAIN}/${URL}/#breadcrumb`,
    ...
    const head = () => (
        <Head>
            ...
            <meta property="og:image" content={`${DOMAIN}/images/operation-true-love/${IMAGE_PREFIX}/chapter-${chapterNumber}/1.webp`} />
            <meta property="og:image:secure_url" content={`${DOMAIN}/images/operation-true-love/${IMAGE_PREFIX}/chapter-${chapterNumber}/1.webp`} />
